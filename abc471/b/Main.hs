...
solve = do
  ...
  printBSB . maximum . map length . group . V.toList $ V.modify VAI.sort $ V.map (BS.map toLower) ss

-- verification-helper: PROBLEM https://atcoder.jp/contests/abc471/tasks/abc471_b
main :: IO ()
main = runIO solve
