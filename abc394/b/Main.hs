...
solve = do
  ...
  let ss' = V.modify (VAI.sortBy (comparing (BS.length))) ss
  printBSB $ V.foldMap showBSB ss'

-- verification-helper: PROBLEM https://atcoder.jp/contests/abc394/tasks/abc394_b
main :: IO ()
main = runIO solve
