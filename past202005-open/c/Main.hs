...
solve = do
  ...
  let x = a * powerOr 1 (n - 1) (\a b -> min (10^9 + 1) (a * b)) r
  printBSB $ if x > 10 ^ 9 then showBSB "large" else showBSB x

-- verification-helper: PROBLEM https://atcoder.jp/contests/past202005-open/tasks/past202005-open_c
main :: IO ()
main = runIO solve
