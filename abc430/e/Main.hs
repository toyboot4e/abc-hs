...
import qualified AtCoder.Extra.Monoid.RollingHash as RH
...
newRH :: BS.ByteString -> U.Vector RH
...
-- verification-helper: PROBLEM https://atcoder.jp/contests/abc430/tasks/abc430_e
main :: IO ()
main = runIO $ do
  t <- int'
  replicateM_ t solve
