...
solve = do
  ...
  let res = U.sum $ U.generate n $ \l -> do
          let r1 = B.maxRight l n $ \r -> na +! (l, r) < a
              r2 = B.maxRight l n $ \r -> nb +! (l, r) < b
           in r2 - r1

  printBSB res

-- verification-helper: PROBLEM https://atcoder.jp/contests/abc430/tasks/abc430_c
main :: IO ()
main = runIO solve
