...
solve = do
  ...
  printBSB $ add2 (1, 1) res

-- verification-helper: PROBLEM https://atcoder.jp/contests/abc364/tasks/abc364_b
main :: IO ()
main = runIO solve
